...
- Results are cached in your browser for 7 days (up to 3,000 models), and the cache is saved while the browser is idle so it never stalls scrolling.
- Badges use no blur or glow filters, so dozens of them on a page don't slow down scrolling.
